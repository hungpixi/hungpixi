...
## 🏆 Featured Hackathons & Active Projects

Actively pushing the boundaries of what local AI running on Edge devices and web architectures can achieve in competitive hackathon environments:
...
![Gemini](https://img.shields.io/badge/LLM%20Pipelines-4285F4?style=flat-square&logo=google&logoColor=white)
![DeepSeek](https://img.shields.io/badge/DeepSeek%20Agents-0055FF?style=flat-square&logo=deepseek&logoColor=white)
...
> Learning remotely by choice to allocate full-time bandwidth toward building high-impact AI/Automation pipelines and competing in hackathons while completing formal CS fundamentals.

**BTEC HND in Business** (Graduated 2024)
*Foundation in business analysis and strategic thinking* — Bridging the gap between code output and commercial value.

---

## 🌏 Let's Connect

Open to exciting opportunities in **AI Architecture, Data Automation, and Growth Systems**.
...
*Built with passion, caffeine, and AI logic.*
</div>
